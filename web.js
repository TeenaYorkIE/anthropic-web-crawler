...
(async () => {
  ...
  await delay(60000); // manual login

  // -----------------------------
  // ✅ STEP 1: Get lesson links
  // -----------------------------
  ...
  for (let i = 0; i < lessonLinks.length; i++) {
    ...
    try {
      ...
      // -----------------------------
      // ✅ Extract mediaId from JW Player
      // -----------------------------
      ...
      const filePath = path.join(
        OUTPUT_DIR,
        `video_${String(i + 1).padStart(2, "0")}.m3u8`
      );
